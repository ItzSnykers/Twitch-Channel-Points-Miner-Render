...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1288937306081853470/F-wOs7G7r9VfDN-EB_J4PyOo9-XK3MvyfoRsq1y2eeeuddl9mJo7fw2BaZEhuXRxnquS",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.GAIN_FOR_WATCH, Events.GAIN_FOR_CLAIM, Events.GAIN_FOR_WATCH_STREAK, Events.BET_WIN]                                 # Only these events will be sent to the chat
        ),
        matrix=Matrix(
